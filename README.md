...
## Bug/Issue tracking
Please log and track bug/issue using https://github.com/forcedotcom/ApexUnit/issues
We resolve P0 issues ASAP. Lower priority bugs will be addressed based on prioritization and availability of the contributors. We encourage users to contribute to the code base. Please feel free to suggest resolutions to the issues logged.
